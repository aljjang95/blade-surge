...
const specs = [
  ['anchor', '정박자의 맹세', 0x56c8bf, '회피한 자리에 닻을 남겨 0.6초 뒤 주변 적을 끌어온다. 재사용 4초', '닻의 흡인 범위가 3에서 4.5로 증가 · 검성 기본 직업의 솔로 전투에서 성검 일섬이 지면 균열로 변해 전방 한 지점에 지연 파열 3회를 남김', ['계류검', '항만 흉갑', '닻고리', '잠수 장화']],
  ['echo', '잔향의 결투', 0xb3a0ef, '같은 적에게 3회 명중 후 회피하면 표식을 터뜨린다. 표식 유지 4초', '표식 피해가 공격력 60%에서 100%로 증가 · 검성 기본 직업의 솔로 전투에서 성검 일섬이 귀환 검기로 변해 반대 방향에서 한 번 더 관통', ['소리굽쇠 검', '공명 갑주', '여운의 반지', '잔음 각반']],
  ...
  ['aegis', '보루의 약속', 0x94b6e6, '일반 스킬 사용 후 3초 안에 회피하면 피해 감소 15%를 1초간 획득', '회피 후 피해 감소가 25%로 증가 · 검성 기본 직업의 솔로 전투에서 성검 일섬이 좁고 빠른 집중 관통으로 대체되어 정예 압박을 높임', ['성문 대검', '보루 판금', '성벽 인장', '수비대 철화']],
];
