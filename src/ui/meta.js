...
export class Meta {
  ...
  renderHeroes() {
    ...
    $('h-lv').onclick = () => {
      ...
      if (this.eco.levelUpHero(id)) { audio.levelUp({ vol: 0.42 }); audio.vibe(20); this.ui.toast(`사냥과 훈련으로 Lv.${this.eco.hero(id).level} 달성!`, 'gold'); }
