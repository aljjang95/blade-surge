...
export const KNIGHT_SLASH_VARIANTS = Object.freeze({
  classic: Object.freeze({ id:'classic', name:'기본 일섬', short:'현재 성검 일섬 유지', setId:null, selectable:false }),
  return: Object.freeze({ id:'return', name:'귀환 검기', short:'왕복 궤적으로 같은 적을 다시 벤다', setId:'echo', selectable:true }),
  fissure: Object.freeze({ id:'fissure', name:'지면 균열', short:'검기가 지난 자리에 지연 파열을 남긴다', setId:'anchor', selectable:true }),
  pierce: Object.freeze({ id:'pierce', name:'집중 관통', short:'폭을 줄이고 정예·보스 압박을 높인다', setId:'aegis', selectable:true }),
});
