...
export const HEROES = {
  knight: {
    id: 'knight', name: '검성 아르카', title: '성검의 계승자', rarity: 'SSR', model: 'Knight', portrait: '/img/tll/knight-casual-v2.png',
  ...
  barbarian: {
    id: 'barbarian', name: '광전사 드라칸', title: '피의 도끼', rarity: 'SSR', model: 'Barbarian', portrait: '/img/tll/barbarian-casual-v2.png',
  ...
  mage: {
    id: 'mage', name: '대마도사 리아', title: '별을 부르는 자', rarity: 'SR', model: 'Mage', portrait: '/img/tll/mage-casual-v2.png',
  ...
  rogue: {
    id: 'rogue', name: '암살자 카인', title: '그림자 속의 칼날', rarity: 'SR', model: 'Rogue', portrait: '/img/tll/rogue-casual-v2.png',
