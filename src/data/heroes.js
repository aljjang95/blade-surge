...
export const HEROES = {
  knight: {
    id: 'knight', name: '검성 아르카', title: '성검의 계승자', rarity: 'SSR', model: 'Knight', portrait: '/img/tll/knight-original-v1.webp',
    ...
    skills: [
      { id: 'holy_slash',  name: '성검 일섬', icon: '/img/sk_knight_1.webp', cd: 5, mp: 16,  anim: '1H_Melee_Attack_Slice_Horizontal', castAt: 0.4, dmg: 3.2, desc: '전방으로 거대한 빛의 참격을 날려 관통 피해' },
      { id: 'shield_bash', name: '철벽 강타', icon: '/img/sk_knight_2.webp', cd: 8, mp: 20,  anim: 'Block_Hit', castAt: 0.35, dmg: 2.4, desc: '방패로 지면을 강타해 주변 적을 기절시키고 밀쳐냄' },
      { id: 'judgment',    name: '심판의 빛', icon: '/img/sk_knight_3.webp', cd: 12, mp: 24, anim: 'Spellcast_Raise', castAt: 0.5, dmg: 2.0, desc: '주변 모든 적에게 빛의 기둥이 낙하' },
      { id: 'dragon_slash', name: '용살검 · 천공', icon: '/img/sk_knight_ult.webp', ult: true, anim: '2H_Melee_Attack_Chop', castAt: 0.55, dmg: 8.0, desc: '하늘을 가르는 일격. 전방 광역에 압도적인 피해' },
      // ── 각성 (레벨 구간 해금) ──
  ...
  barbarian: {
    id: 'barbarian', name: '광전사 드라칸', title: '피의 도끼', rarity: 'SSR', model: 'Barbarian', portrait: '/img/tll/barbarian-original-v1.webp',
    ...
    skills: [
      { id: 'whirlwind',  name: '회오리 참격', icon: '/img/sk_barb_1.webp', cd: 7, mp: 16,  anim: '2H_Melee_Attack_Spin', castAt: 0.3, dmg: 0.9, ticks: 5, desc: '도끼를 휘돌려 주변 적을 연속으로 베어냄' },
      { id: 'quake',      name: '대지 분쇄', icon: '/img/sk_barb_2.webp', cd: 10, mp: 20, anim: '2H_Melee_Attack_Chop', castAt: 0.5, dmg: 4.0, desc: '땅을 내리쳐 충격파로 광역 피해와 넉백' },
      { id: 'berserk',    name: '광폭화',   icon: '/img/sk_barb_3.webp', cd: 16, mp: 24, anim: 'Cheer', castAt: 0.2, dmg: 0, desc: '8초간 공격력 +60%, 공격속도 +30%' },
      { id: 'hell_axe',   name: '지옥의 도끼', icon: '/img/sk_barb_ult.webp', ult: true, anim: 'Jump_Full_Short', castAt: 0.5, dmg: 9.0, desc: '불타는 거대 도끼를 낙하시켜 전장을 불태움' },
      // ── 각성 (레벨 구간 해금) ──
      ...
      { id: 'cataclysm', name: '종말 · 화산심장', icon: '/img/sk_bb_a2.webp', cd: 28, mp: 52, unlock: 50, awaken: 4, anim: 'Jump_Full_Short', castAt: 0.55, dmg: 6.8, desc: '도약 후 전장을 뒤엎는 화산 폭발을 일으킨다' },
    ],
  },
  mage: {
    id: 'mage', name: '대마도사 리아', title: '별을 부르는 자', rarity: 'SR', model: 'Mage', portrait: '/img/tll/mage-original-v1.webp',
    ...
    skills: [
      { id: 'fireball',   name: '화염구',     icon: '/img/sk_mage_1.webp', cd: 5, mp: 16,  anim: 'Spellcast_Shoot', castAt: 0.35, dmg: 3.5, desc: '폭발하는 화염구를 발사해 광역 피해' },
      { id: 'chain',      name: '번개 사슬',  icon: '/img/sk_mage_2.webp', cd: 9, mp: 20,  anim: 'Spellcast_Raise', castAt: 0.45, dmg: 2.2, desc: '적들을 연쇄하는 번개. 최대 6명 타격' },
      { id: 'blizzard',   name: '빙결 폭풍',  icon: '/img/sk_mage_3.webp', cd: 13, mp: 24, anim: 'Spellcast_Long', castAt: 0.5, dmg: 0.8, ticks: 6, desc: '주변에 얼음 폭풍을 일으켜 지속 피해와 둔화' },
      { id: 'meteor',     name: '메테오 스톰', icon: '/img/sk_mage_ult.webp', ult: true, anim: 'Spellcast_Raise', castAt: 0.5, dmg: 2.8, ticks: 5, desc: '하늘에서 운석이 쏟아져 전장을 초토화' },
      // ── 각성 (레벨 구간 해금) ──
      ...
      { id: 'absolute_zero', name: '절대영도 · 종언', icon: '/img/sk_mg_a2.webp', cd: 28, mp: 52, unlock: 50, awaken: 4, anim: 'Spellcast_Raise', castAt: 0.5, dmg: 6.6, desc: '넓은 구역을 얼린 뒤 지연 폭발로 파쇄한다' },
    ],
  },
  rogue: {
    id: 'rogue', name: '암살자 카인', title: '그림자 속의 칼날', rarity: 'SR', model: 'Rogue', portrait: '/img/tll/rogue-original-v1.webp',
    ...
    skills: [
      { id: 'shadow_dash', name: '그림자 질주', icon: '/img/sk_rogue_1.webp', cd: 6, mp: 16,  anim: 'Dodge_Forward', castAt: 0.1, dmg: 2.6, desc: '적을 관통하며 질주해 경로상 모든 적을 베어냄' },
      { id: 'poison_bomb', name: '독무 폭탄',   icon: '/img/sk_rogue_2.webp', cd: 9, mp: 20,  anim: 'Throw', castAt: 0.45, dmg: 0.6, ticks: 8, desc: '독 연막을 투척해 지속 피해' },
      { id: 'flurry',      name: '환영 난무',   icon: '/img/sk_rogue_3.webp', cd: 11, mp: 24, anim: 'Dualwield_Melee_Attack_Stab', castAt: 0.2, dmg: 0.7, ticks: 8, desc: '잔상을 남기며 8연속 찌르기' },
      { id: 'thousand',    name: '천 개의 칼날', icon: '/img/sk_rogue_ult.webp', ult: true, anim: 'Spellcast_Raise', castAt: 0.4, dmg: 0.95, ticks: 10, desc: '하늘에서 수천의 칼날이 쏟아짐' },
      // ── 각성 (레벨 구간 해금) ──
      ...
      { id: 'eclipse_edge', name: '일식 · 무영절명', icon: '/img/sk_rg_a2.webp', cd: 28, mp: 52, unlock: 50, awaken: 4, anim: 'Dodge_Forward', castAt: 0.1, dmg: 6.4, desc: '적을 연쇄 베기한 뒤 마지막 지점에서 일식 폭발을 일으킨다' },
    ],
  },
  ...
  skills: [
    { id: 'ranger_pierce', name: '바람 관통화살', icon: '/img/skills-crafted/ranger-pierce.webp', cd: 4, mp: 16, anim: 'Bow_Shoot', castAt: .42, dmg: 2.8, desc: '관통 화살. 집중 3을 소비하면 피해 2배와 판정 확대' },
    { id: 'ranger_volley', name: '삼중 추적화살', icon: '/img/skills-crafted/ranger-volley.webp', cd: 8, mp: 20, anim: 'Bow_Shoot', castAt: .42, dmg: 2, desc: '부채꼴 관통 화살 3발. 적을 2초간 둔화' },
    { id: 'ranger_retreat', name: '바람의 이탈', icon: '/img/skills-crafted/ranger-retreat.webp', cd: 10, mp: 24, anim: 'Bow_Shoot', castAt: .42, dmg: 2.2, desc: '화살을 쏘며 짧게 후퇴. 0.6초 무적과 집중 +1' },
    { id: 'ranger_tempest', name: '궁극 · 폭풍의 일곱 화살', icon: '/img/skills-crafted/ranger-tempest.webp', ult: true, anim: 'Bow_Shoot', castAt: .42, dmg: 1.9, desc: '넓은 부채꼴 관통 화살 7발. 집중 3을 소비하면 각 화살 피해 50% 증가' },
    ...
    { id: 'skyfall_arrows', name: '천궁 · 유성화살비', icon: '/img/skills-crafted/ranger-binding.webp', cd: 28, mp: 52, unlock: 50, awaken: 4, anim: 'Bow_Shoot', castAt: .42, dmg: 6.2, desc: '유성처럼 낙하하는 화살이 넓은 지역을 연속 폭격한다' },
  ],
  },
};
