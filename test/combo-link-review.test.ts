...
function fixture(){
 ...
 fx:{dmgLayer:{children:[]},damage:noop,shockTex:noop,embers:noop,slashSprite:noop,ghost:noop,explosion:noop},renderer:{shake:noop},ui:{setCombo:noop,toast:noop},timeCtl:{hitstop:noop},vacuum:noop});
