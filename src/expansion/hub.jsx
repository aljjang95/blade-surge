...
function Panel({controller, revision}) {
  ...
  return <section className="exp-shell" aria-labelledby="exp-title">
    ...
    {app.journeyView && <button className="exp-film-link" disabled={!!result?.saveError} onClick={()=>app.journeyView.open(result?'contracts':'journey')}>성장 여정 · 의뢰 보상과 다음 장비 확인</button>}
