...
const specs = [
  ['anchor', '정박자의 맹세', 0x56c8bf, '회피한 자리에 닻을 남겨 0.6초 뒤 주변 적을 끌어온다. 재사용 4초', '닻의 흡인 범위가 3에서 4.5로 증가 · 검성 장착 시 성검 일섬이 지면 균열로 변해 경로에 지연 파열 3회를 남김', ['계류검', '항만 흉갑', '닻고리', '잠수 장화']],
  ...
  ['aegis', '보루의 약속', 0x94b6e6, '일반 스킬 사용 후 3초 안에 회피하면 피해 감소 15%를 1초간 획득', '회피 후 피해 감소가 25%로 증가 · 검성 장착 시 성검 일섬이 집중 관통으로 변해 좁고 빠른 추가 검기를 발사', ['성문 대검', '보루 판금', '성벽 인장', '수비대 철화']],
];
